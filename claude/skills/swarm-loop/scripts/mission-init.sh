...
# usage: mission-init.sh <mission-slug> "<mission goal>" [interactive|mission] [self-improve-targets]
...
slug="${1:?usage: mission-init.sh <mission-slug> \"<goal>\" [interactive|mission] [self-improve-targets]}"
