let
  # User identity — used to derive homeDirectories and dotfilesDir below
  username = "kpango";
  homeLinux = "/home";
  homeDarwin = "/Users";
...
in
{
  ...
  dotfilesDir = {
    linux = "${homeLinux}/${username}/go/src/github.com/kpango/dotfiles";
    darwin = "${homeDarwin}/${username}/go/src/github.com/kpango/dotfiles";
  };
  ...
  darwin = {
    homebrew = {
      ...
      cleanup = "zap";
      taps = [
        # homebrew/bundle merged into brew core (4.x); cask-fonts merged into homebrew/cask
        "homebrew/autoupdate"
      ];
      casks = [
        "discord"
