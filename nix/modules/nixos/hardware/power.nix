...

{
  ...
  services.thinkfan.sensors = lib.mkIf config.services.thinkfan.enable settings.hardware.thinkfan.sensors;
  services.thinkfan.levels = lib.mkIf config.services.thinkfan.enable settings.hardware.thinkfan.levels;
}
