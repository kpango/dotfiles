...
curl --retry 3 --retry-all-errors --retry-delay 3 -fsSLO https://raw.githubusercontent.com/kpango/dotfiles/main/arch/chroot_p1.sh
...
curl --retry 3 --retry-all-errors --retry-delay 3 -fsSLO https://raw.githubusercontent.com/kpango/dotfiles/main/arch/pkg_p1.list
pacman -Sy --noconfirm
