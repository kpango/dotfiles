...
curl --retry 3 --retry-all-errors --retry-delay 3 -fsSLO https://raw.githubusercontent.com/kpango/dotfiles/main/arch/chroot_desk.sh
curl --retry 3 --retry-all-errors --retry-delay 3 -fsSLO https://raw.githubusercontent.com/kpango/dotfiles/main/arch/user-init.sh
curl --retry 3 --retry-all-errors --retry-delay 3 -fsSLO https://raw.githubusercontent.com/kpango/dotfiles/main/arch/locale.gen
curl --retry 3 --retry-all-errors --retry-delay 3 -fsSLO https://raw.githubusercontent.com/kpango/dotfiles/main/arch/pkg_desk.list
pacman -Sy --noconfirm
