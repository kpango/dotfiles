...
curl -fsSLO https://raw.githubusercontent.com/kpango/dotfiles/main/arch/chroot_desk.sh
...
curl -fsSLO https://raw.githubusercontent.com/kpango/dotfiles/main/arch/pkg_desk.list
pacman -Sy --noconfirm
