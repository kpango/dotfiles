...
local keymaps = {
    ...
    { "n", "<leader>wa", "<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>",                       { noremap = true, silent = true } },
    { "n", "<leader>wr", "<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>",                    { noremap = true, silent = true } },
    { "n", "<leader>wl", "<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>", { noremap = true, silent = true } },
    ...
    { "n", "<leader>ca", "<cmd>lua vim.lsp.buf.code_action()<CR>",                                { noremap = true, silent = true } },
    { "n", "<leader>e",  "<cmd>lua vim.diagnostic.open_float()<CR>",                              { noremap = true, silent = true } },
    ...
    { "n", "<leader>q",  "<cmd>lua vim.diagnostic.setloclist()<CR>",                              { noremap = true, silent = true } },
    { "n", "<leader>f",  "<cmd>lua vim.lsp.buf.formatting()<CR>",                                 { noremap = true, silent = true } },
    -- Telescope
    { "n", "<C-p>",      ":Telescope find_files<CR>",                                             { noremap = true, silent = true } },
    { "n", "<C-f>",      ":Telescope live_grep<CR>",                                              { noremap = true, silent = true } },
    -- Bufferline
    { "n", "<Tab>",      "<Cmd>BufferLineCycleNext<CR>",                                          { noremap = true, silent = true } },
    { "n", "<S-Tab>",    "<Cmd>BufferLineCyclePrev<CR>",                                          { noremap = true, silent = true } },
    -- Gitsigns
    { "n", "]c", function()
