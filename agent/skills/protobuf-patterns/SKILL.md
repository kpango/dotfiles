...
description: Protobuf schema design, breaking change avoidance, buf lint/breaking rules, gRPC service patterns, and code generation workflows for production APIs. 実装作業自体は proto-expert agent に委譲する。
...
option go_package = "github.com/yourorg/yourapp/gen/go/myapp/v1";
option java_multiple_files = true;
option java_package = "com.yourorg.myapp.v1";

import "google/api/annotations.proto";
import "buf/validate/validate.proto";
```

(vald での実例: `package vald.v1;` / `option go_package = "github.com/vdaas/vald/apis/grpc/v1/vald";` 等)
...
# In vald, use make proto/all (Core Principles) — not buf generate directly:
