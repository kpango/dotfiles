---
name: zig-patterns
description: Zig language idioms, comptime, memory management, error handling, and C interop patterns for safe, performant systems programming. 実装作業自体は zig-expert agent に委譲する — Zigは破壊的変更が頻繁なため、本ファイルの具体的コード例がAgent作成時点のZigバージョンより古い可能性がある点に注意。
