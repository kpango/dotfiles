---
name: python-testing
description: Python testing strategies using pytest, TDD methodology, fixtures, mocking, parametrization, and coverage requirements. 実装作業自体は python-expert agent に委譲する。
origin: ECC
---
...
Full code examples live in `reference.md`; this file covers when to use each pattern and the core decision criteria.
