---
name: claude-api-go
description: Claude API / Anthropic Go SDK usage patterns, prompt caching, streaming, tool use, and model selection for Go applications. 実装作業自体は go-expert agent に委譲する。
...
- Not caching large system prompts (see Prompt Caching above)
