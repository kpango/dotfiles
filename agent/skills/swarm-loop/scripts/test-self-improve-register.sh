...
# self-improve-register.sh は registry パスを readlink -f "$0" でファイル自身のsymlinkを解決した
# 上で dirname を2回適用して解決する (2026-09-04以降、HARNESS_REGISTRY のような env override は
# 無い)。実 registry を汚さないよう、
