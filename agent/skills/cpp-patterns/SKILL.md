---
name: cpp-patterns
description: C++ coding standards based on the C++ Core Guidelines (isocpp.github.io). Use when writing, reviewing, or refactoring C++ code to enforce modern, safe, and idiomatic practices. 実装作業自体は cpp-expert agent に委譲する(systems-lang-adversarial-reviewerはGATE直前の言語仕様レビュー専用で別物)。
origin: ECC
---
