---
name: k8s-patterns
description: Kubernetes manifest patterns, Operators, Helm, kustomize, kubectl debugging, and production readiness for Go-based services. 実装作業自体は k8s-expert agent に委譲する(vald リポジトリ配下の Vald Law/config sync 固有の作業は vald-reviewer)。
