 ...
 */
/**
 * Emit a value as a safe single-line YAML scalar. Newlines are collapsed to
 * spaces and the value is double-quoted + escaped when it contains characters
 * that would otherwise break or be misparsed in `key: value` frontmatter
 * (colon-space, `#`, quotes, or leading indicator chars). Plain simple values
