...
replace (
	...
	github.com/suzuki-shunsuke/ghalint => github.com/suzuki-shunsuke/ghalint v1.5.6-0.20260209015703-9ab80a59bdc1
...
require (
	...
	golang.org/dl v0.0.0-20260204154827-72e8de5a5ad2 // indirect
