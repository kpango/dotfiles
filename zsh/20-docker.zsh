...
devrun() {
	...
	darwin*)
		...
		container exec -u 0 $container_name sh -c \
			...
			container exec -u 0 $container_name \
				...
				"$container_home/.config/sheldon" 2>/dev/null || true
		devin
		;;
	...
	linux*)
		...
		local -a run_cmd=(
			...
			-v "$rcpath/atuin/config.toml:$container_home/.config/atuin/config.toml:ro"
			-v "$rcpath/atuin/themes/zed_kpango.toml:$container_home/.config/atuin/themes/zed_kpango.toml"
			...
			-v "$rcpath/gitui/key_bindings.ron:$container_home/.config/gitui/key_bindings.ron"
			-v "$rcpath/gitui/theme.ron:$container_home/.config/gitui/theme.ron"
			-v "$rcpath/herdr/config.toml:$container_home/.config/herdr/config.toml:ro"
			-v "$HOME/.config/herdr/sessions:$container_home/.config/herdr/sessions"
			-v "$rcpath/lumen.json:$container_home/.config/lumen/lumen.config.json"
			...
			-v ${XDG_CONFIG_HOME:-$HOME/.config}/gcloud:$container_home/.config/gcloud
			...
			-v $rcpath/go.env:/usr/local/go/go.env:ro
